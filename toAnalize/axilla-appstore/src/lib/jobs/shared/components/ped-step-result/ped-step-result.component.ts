...
@Component({
  selector: 'app-ped-step-result',
  templateUrl: './ped-step-result.component.html',
  encapsulation: ViewEncapsulation.None
})
export class PEDStepResultComponent extends AppComponentBase implements OnInit {

  private _openedValue: any;
  @Input() set openedValue(openedValue: any) {
    this._openedValue = openedValue;
  }

  get openedValue() {
    return this._openedValue;
  }
