...
import { AppComponentBase, accountModuleAnimation, UrlHelper } from '@axilla/axilla-shared';
...
export class LoginComponent extends AppComponentBase implements OnInit {
    ...
    hunterLogo = '/assets/common/images/logo-hunter.png';

    get isShowAcc(): boolean {

        return document.location.host.includes('acc_') || document.location.host.includes('dev_');
    }
    ...
    get isTenantRegistrationAllowed(): boolean {
        return this.setting.getBoolean('App.UserManagement.AllowTenantRegistration');
    }
    ...
    get isFreeEdition() {
        return abp.features.isEnabled('App.Ubl.CreateNewInvoiceFromHome');
    }
}
