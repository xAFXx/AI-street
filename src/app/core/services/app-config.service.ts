...
export class AppConfigService {
        ...
        return this.http.get<AppConfig>('/assets/appconfig.json').pipe(
            ...
            catchError((error) => {
                ...
                const defaultConfig: AppConfig = {
                    remoteServiceBaseUrl: 'https://dev_ihsc-connectapi.apprx.eu',
                    appBaseUrl: 'https://dev_ihsc.apprx.eu',
    ...
    extractTenancyFromHostname(): string {
        ...
        // Try to extract from hostname pattern: dev_TENANT.apprx.eu or TENANT.apprx.eu
        const patterns = [
            /^dev_([^.]+)\.apprx\.eu$/,  // dev_tenant.apprx.eu
            /^([^.]+)\.apprx\.eu$/,       // tenant.apprx.eu
            /^dev_([^.]+)-connect/,       // dev_tenant-connectapi.apprx.eu
            /^([^.]+)-connect/            // tenant-connectapi.apprx.eu
        ];
