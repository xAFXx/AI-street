    ...
    private static getApplicationConfig(appRootUrl: string, callback: () => void, reject: (error: any) => void): void {
        ...
        XmlHttpRequestHelper.ajax(
            ...
            (error) => {
                ...
                AppConsts.remoteServiceBaseUrl = 'https://demo-connectapi.apprx.eu';
                AppConsts.appBaseUrl = 'https://demo.apprx.eu';
                AppConsts.remoteServiceBaseUrlFormat = 'https://dev_{TENANCY_NAME}-connectapi.apprx.eu';
                AppConsts.appBaseUrlFormat = 'https://dev_{TENANCY_NAME}.apprx.eu';
